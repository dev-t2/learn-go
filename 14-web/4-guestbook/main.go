...
func viewHandler(res http.ResponseWriter, req *http.Request) {
	signatures := getStrings("14-web/4-guestbook/signatures.txt")

	html, err := template.ParseFiles("14-web/4-guestbook/view.html")
...
func newHandler(res http.ResponseWriter, req *http.Request) {
	html, err := template.ParseFiles("14-web/4-guestbook/new.html")
...
func createHandler(res http.ResponseWriter, req *http.Request) {
	...
	file, err := os.OpenFile("14-web/4-guestbook/signatures.txt", options, os.FileMode(0600))
